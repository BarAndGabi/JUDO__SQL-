...
VALUES
 ('401', '101', '109', '2023-02-13', '10:00:00', '204', 'MHO'),
    ('402', '101', '117', '2023-03-18', '14:00:00', '205', 'MHO'),
    ('403', '101', '125', '2023-08-27', '16:30:00', '203', 'MHO'),
    ('404', '109', '117', '2023-01-01', '19:00:00', '204', 'MHO'),
    ('405', '109', '125', '2023-09-29', '21:30:00', '203', 'MHO'),
    ('406', '117', '125', '2023-01-29', '16:00:00', '205', 'MHO'),
    ('407', '102', '110', '2023-08-03', '18:30:00', '207', 'MHY'),
    ('408', '102', '118', '2023-03-07', '14:30:00', '203', 'MHY'),
    ('409', '102', '126', '2023-10-08', '15:30:00', '207', 'MHY'),
    ('410', '110', '118', '2023-08-02', '13:00:00', '207', 'MHY'),
    ('411', '110', '126', '2023-06-10', '18:30:00', '204', 'MHY'),
    ('412', '118', '126', '2023-05-09', '14:00:00', '207', 'MHY'),
    ('413', '103', '111', '2023-10-13', '15:00:00', '203', 'MLO'),
    ('414', '103', '119', '2023-01-01', '13:00:00', '205', 'MLO'),
    ('415', '103', '127', '2023-05-12', '16:30:00', '203', 'MLO'),
    ('416', '111', '119', '2023-02-14', '17:30:00', '207', 'MLO'),
    ('417', '111', '127', '2023-07-06', '15:00:00', '206', 'MLO'),
    ('418', '119', '127', '2023-06-08', '16:30:00', '203', 'MLO'),
    ('419', '104', '112', '2023-02-07', '10:00:00', '207', 'MLY'),
    ('420', '104', '120', '2023-05-20', '10:00:00', '204', 'MLY'),
    ('421', '104', '128', '2023-07-19', '17:00:00', '203', 'MLY'),
    ('422', '112', '120', '2023-04-02', '12:30:00', '203', 'MLY'),
    ('423', '112', '128', '2023-09-17', '17:30:00', '207', 'MLY'),
    ('424', '120', '128', '2023-03-07', '13:30:00', '204', 'MLY'),
    ('425', '105', '113', '2023-10-08', '21:30:00', '203', 'FHO'),
    ('426', '105', '121', '2023-02-14', '21:30:00', '206', 'FHO'),
    ('427', '105', '129', '2023-01-21', '13:00:00', '206', 'FHO'),
    ('428', '113', '121', '2023-01-03', '18:00:00', '206', 'FHO'),
    ('429', '113', '129', '2023-03-06', '14:00:00', '204', 'FHO'),
    ('430', '121', '129', '2023-01-04', '11:00:00', '207', 'FHO'),
    ('431', '106', '114', '2023-01-24', '19:00:00', '207', 'FLO'),
    ('432', '106', '122', '2023-10-04', '18:30:00', '204', 'FLO'),
    ('433', '106', '130', '2023-02-15', '12:30:00', '207', 'FLO'),
    ('434', '114', '122', '2023-09-05', '9:30:00', '207', 'FLO'),
    ('435', '114', '130', '2023-02-13', '21:00:00', '205', 'FLO'),
    ('436', '122', '130', '2023-05-23', '22:00:00', '205', 'FLO'),
    ('437', '107', '115', '2023-09-20', '9:30:00', '207', 'FHY'),
    ('438', '107', '123', '2023-09-27', '13:30:00', '203', 'FHY'),
    ('439', '107', '131', '2023-06-23', '10:00:00', '206', 'FHY'),
    ('440', '115', '123', '2023-01-25', '9:30:00', '203', 'FHY'),
    ('441', '115', '131', '2023-03-02', '16:00:00', '205', 'FHY'),
    ('442', '123', '131', '2023-09-22', '12:00:00', '205', 'FHY'),
    ('443', '108', '116', '2023-07-31', '11:30:00', '207', 'FLY'),
    ('444', '108', '124', '2023-05-03', '12:30:00', '206', 'FLY'),
    ('445', '108', '132', '2023-04-05', '14:30:00', '203', 'FLY'),
    ('446', '116', '124', '2023-08-16', '16:30:00', '204', 'FLY'),
    ('447', '116', '132', '2023-03-05', '17:30:00', '204', 'FLY'),
    ('448', '124', '132', '2023-04-22', '14:00:00', '205', 'FLY');
    
    insert into judo.fouls( id,`foul type`,battles_id,judokas_id,battles_judge_id)
    values  ('501', '1', '421', '104', '203'),
    ('502', '2', '422', '112', '203'),
    ('503', '2', '423', '112', '207'),
    ('504', '2', '424', '120', '204'),
    ('505', '2', '425', '105', '203'),
